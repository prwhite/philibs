...
#ifndef scenesceneddogllist2_h
#define scenesceneddogllist2_h
  ...
  public scene::stateDd
{
  public:
    ddOglList2();
    virtual ~ddOglList2();
//     ddOglList2(ddOglList2 const& rhs);
//     ddOglList2& operator=(ddOglList2 const& rhs);
//     bool operator==(ddOglList2 const& rhs) const;
